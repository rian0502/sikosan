...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 05, 2022 at 07:19 AM
...
INSERT INTO `komentar` (`id`, `id_kosan`, `id_user`, `komentar`, `created_at`, `updated_at`) VALUES
...
--
ALTER TABLE `wishlist`
  MODIFY `id_wishlist` int(11) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
...
--
ALTER TABLE `reply_komentar`
  ADD CONSTRAINT `reply_komentar_id_komentar_foreign` FOREIGN KEY (`id_komentar`) REFERENCES `komentar` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
