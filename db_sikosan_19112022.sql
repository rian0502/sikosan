...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 19 Nov 2022 pada 14.17
...
(1, 4, 4, 'Penjual jangan dipercaya', '2022-11-15 20:47:38', '2022-11-15 20:47:38');
...
(34, '2022-11-15-154213', 'App\\Database\\Migrations\\ReportKomentar', 'default', 'App', 1668862851, 3);
...
(1, 1, 5, 'Ahh yang bener', '2022-11-15 20:48:32', '2022-11-15 20:48:32');

-- --------------------------------------------------------

--
-- Struktur dari tabel `report_komentar`
--
...
--
-- Dumping data untuk tabel `report_komentar`
--

INSERT INTO `report_komentar` (`id_report_komentar`, `id_user`, `id_user_komentar`, `laporan_komentar`, `komentar_dilaporkan`, `isReply`, `created_at`, `updated_at`) VALUES
(1, 5, 4, 'Komentar ini mengandung ujaran kebencian', 'Penjual jangan dipercaya', 0, '2022-11-19 20:03:46', '2022-11-19 20:03:46'),
(3, 4, 5, 'Komentar ini mengandung penjualan tidak resmi', 'Ahh yang bener', 1, '2022-11-19 20:13:33', '2022-11-19 20:13:33');

-- --------------------------------------------------------

--
-- Struktur dari tabel `report_kosan`
--
...
--
-- Dumping data untuk tabel `report_kosan`
--
...
(4, 'Customer 1', '082418471847', 'customer1@gmail.com', NULL, '$2y$10$3gfCMpm0DiCqVoK9G1ghMOX2UEtjmoyjRSmnH4AXevy8a6E78ZGW6', NULL, NULL, NULL, NULL, NULL, NULL, 1, 0, '2022-11-15 20:38:42', '2022-11-15 20:38:42', NULL),
(5, 'Customer 2', '0821657645376', 'customer2@gmail.com', NULL, '$2y$10$tCX5lI7K0zu3MlSCR64adOcrE0ixdPA.xNuXFfIzomhRSPNA8jes6', NULL, NULL, NULL, NULL, NULL, NULL, 1, 0, '2022-11-15 20:39:11', '2022-11-15 20:39:11', NULL);
...
--
-- Indeks untuk tabel `report_komentar`
--
ALTER TABLE `report_komentar`
  ADD PRIMARY KEY (`id_report_komentar`);

--
-- Indeks untuk tabel `report_kosan`
--
...
--
ALTER TABLE `komentar`
  MODIFY `id_komentar` int(11) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
...
--
-- AUTO_INCREMENT untuk tabel `report_komentar`
--
ALTER TABLE `report_komentar`
  MODIFY `id_report_komentar` int(11) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT untuk tabel `report_kosan`
--
ALTER TABLE `report_kosan`
