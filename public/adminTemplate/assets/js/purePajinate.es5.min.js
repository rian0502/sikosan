    ...
    _createClass(e, [
      {
        ...
        value: function () {
          ...
          var e = this.config.item_container.querySelectorAll(
            this.config.itemSelector
          );
          if (
            !(this.config.hideOnSmall && this.config.itemsPerPage >= e.length)
          ) {
            this.current_page = this.config.startPage;
            for (var i = 0; i < e.length; i++)
              (e[i].style.display = "none"), e[i].classList.add("hidden");
            for (
              ...
              switch (this.config.navOrder[r]) {
                ...
                case "num":
                  this.config.showPrevNext &&
                    (o += '<li class="ellipse less"><span>...</span></li>');
                  for (var c = 0; t > c; ) {
                    var g = "";
                    0 == c && (g = " first"),
                      c == t - 1 && (g = " last"),
                  ...
                  this.config.showPrevNext &&
                    (o += '<li class="ellipse more"><span>...</span></li>');
              }
            (o += "</ul>"),
              this.config.pagination_containers.forEach(function (e) {
                e.innerHTML = o;
                for (
                  var i = e.querySelectorAll(".page_link"), t = 0;
                  t < i.length;
                  t++
                )
                  (t >=
                    this.config.pageLinksToDisplay + this.config.startPage ||
                    t < this.config.startPage) &&
                ...
                this.config.showFirstLast &&
                  ...
                  e.querySelectorAll(".page_link").forEach(function (e) {
                    e.addEventListener("click", function (i) {
                      i.preventDefault(),
                        a.gotopage(e.getAttribute("longdesc"));
                    });
                  }, a);
              }, this),
      ...
      },
      {
        key: "showFirstPage",
        value: function (e) {
          this.movePageNumbersRight(e.querySelector(".first_link"), 0),
            this.gotopage(0);
        },
      },
      {
        ...
        value: function (e) {
          ...
          this.movePageNumbersLeft(e.querySelector(".last_link"), i),
            this.gotopage(i);
        },
      },
      {
        ...
        value: function (e) {
          ...
          null != t && t.classList.contains("page_link")
            ? (this.movePageNumbersRight(e.querySelector(".previous_link"), i),
              this.gotopage(i))
            : this.config.wrapAround &&
              (this.movePageNumbersLeft(
                e.querySelector(".previous_link"),
      ...
      },
      {
        ...
        value: function (e) {
          ...
          null != t && t.classList.contains("page_link")
            ? (this.movePageNumbersLeft(e.querySelector(".next_link"), i),
              this.gotopage(i))
            : this.config.wrapAround &&
              (this.movePageNumbersRight(e.querySelector(".next_link"), 0),
              this.gotopage(0));
        },
      },
      {
        ...
        value: function (e) {
          ...
          for (
            var i = parseInt(this.config.itemsPerPage),
              t = e * i,
              s = t + i,
              a = this.config.item_container.querySelectorAll(
                this.config.itemSelector
              ),
              n = function (e) {
                e >= s || e < t
          ...
          this.config.pagination_containers.forEach(function (i) {
            for (
              var t = i.querySelectorAll(".page_link"), s = 0;
              s < t.length;
              s++
            )
              t[s].getAttribute("longdesc") == e
                ? (t[s].classList.add("active_page"),
                  t[s].classList.add(this.config.activeClass))
                : (t[s].classList.remove("active_page"),
                  t[s].classList.remove(this.config.activeClass));
          }, this),
            (this.current_page = e),
            this.toggleMoreLess(),
        ...
        value: function (e, i) {
          ...
          e.parentNode.querySelectorAll(".page_link").forEach(function (e) {
            e.getAttribute("longdesc") != t ||
              ...
              this.config.pagination_containers.forEach(function (e) {
                for (
                  var i = e.querySelectorAll(".page_link"), s = 0;
                  s < i.length;
                  s++
                )
                  s < t + 1 &&
                  s >= parseInt(t - this.config.pageLinksToDisplay + 1)
        ...
        value: function () {
          this.config.pagination_containers.forEach(function (e) {
            ...
            null != i &&
              ...
              e.querySelector(".page_link.last") &&
                this.isHidden(e.querySelector(".page_link.last")) &&
                (i.style.display = "inline"));
            var t = e.querySelector(".less");
            null != t &&
              ((t.style.display = "none"),
              e.querySelector(".page_link.first") &&
                this.isHidden(e.querySelector(".page_link.first")) &&
        ...
        value: function () {
          this.config.pagination_containers.forEach(function (e) {
            ...
            e.querySelector(".page_link.last").classList.contains("active_page")
              ? (null != i &&
                  (i.classList.add("no_more"),
                  i.classList.add(this.config.disabledClass)),
                null != a &&
                  (a.classList.add("no_more"),
                  a.classList.add(this.config.disabledClass)))
              : (null != i &&
                  (i.classList.remove("no_more"),
                  i.classList.remove(this.config.disabledClass)),
                null != a &&
                  (a.classList.remove("no_more"),
                  a.classList.remove(this.config.disabledClass))),
              e.querySelector(".page_link.first") &&
              e
                .querySelector(".page_link.first")
                .classList.contains("active_page")
                ? (null != t &&
                    (t.classList.add("no_more"),
                    t.classList.add(this.config.disabledClass)),
                  null != s &&
                    (s.classList.add("no_more"),
                    s.classList.add(this.config.disabledClass)))
                : (null != t &&
                    (t.classList.remove("no_more"),
                    t.classList.remove(this.config.disabledClass)),
                  null != s &&
                    (s.classList.remove("no_more"),
                    s.classList.remove(this.config.disabledClass)));
          }, this);
        },
      },
      {
